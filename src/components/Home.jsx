   ...
   lg:bg-[url('/background-home-desktop.jpg')]">
    <div className="flex flex-col lg:flex-row items-center lg:items-end justify-between h-full pt-28 md:pt-40 pb-20 md:pb-40 max-w-7xl px-4 lg:px-8 mx-auto text-font-white">
      <div className="flex flex-col gap-4 md:gap-6 items-center lg:items-start text-center lg:text-start">
        ...
        className="text-blue-light text-sm md:text-lg lg:text-[28px] tracking-[2.7px] md:tracking-[3px] lg:tracking-[4.75px] font-barlow-condensed uppercase">SO, YOU WANT TO TRAVEL TO</motion.h2>
        <motion.h1 
        initial={{ 
          opacity: 0, 
          fliter:"blur(10px)",
        ...
        className="heading-one-text-style leading-none text-7xl md:text-8xl lg:text-[150px] my-2 md:my-3 
        text-transparent animate-shimmer">SPACE</motion.h1>
        <motion.p 
         initial={{
          opacity:0,
          y:-8,
        ...
        className="text-blue-light paragraph-style text-sm md:text-base lg:text-lg leading-relaxed max-w-[327px] md:max-w-[480px] lg:max-w-[444px]">Let’s face it, if you want to go to space, you might as
