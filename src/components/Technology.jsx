          ...
          <div className="px-4 lg:px-0 lg:pl-3 lg:flex lg:justify-between lg:items-stretch lg:gap-1 lg:w-1/2">
            ...
            >
              <motion.h2 
                ...
                className="font-bellefair uppercase text-white/50 text-base md:text-2xl lg:text-[32px] text-center lg:text-start mb-2 md:mb-4 lg:mb-2"
              >
                The Terminology
              </motion.h2>
              ...
              <motion.h1 
                ...
                className="font-bellefair text-2xl md:text-4xl lg:text-[56px] text-font-white text-center lg:text-start uppercase leading-none mb-4 md:mb-6 lg:mb-4"
              >
                {currentSpaceInfra.name}
              </motion.h1>
              ...
              <motion.p 
                ...
                className="font-barlow text-sm md:text-base lg:text-lg text-blue-light text-center lg:text-start leading-relaxed lg:leading-[1.8] max-w-[330px] md:max-w-[480px] lg:max-w-[450px]"
              >
                {currentSpaceInfra.description}
              </motion.p>
            </motion.article>
          </div>
        </div>
