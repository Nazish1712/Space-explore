      ...
      <main className="pt-28 md:pt-36 lg:pt-40 pb-6 lg:pb-12 min-h-dvh flex flex-col max-w-2xl lg:max-w-7xl m-auto px-4 text-font-white">
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center w-full gap-6 lg:gap-0 mt-3">
          ...
          <div className="flex flex-col justify-between items-center lg:items-start lg:text-left lg:w-1/2">
            ...
            {/* 
              Keyed Wrapper: 
              Only the text changes animate. The dots (below this div) remain static.
            */}
            <motion.div 
            ...
            >
              <motion.h2 
                ...
                className="font-bellefair uppercase text-white/50 text-base md:text-2xl lg:text-[32px] text-center mb-2 md:mb-4"
              >
                {currentMember.role}
              </motion.h2>
              ...
              <motion.h1 
                ...
                className="font-bellefair text-2xl md:text-4xl lg:text-[56px] text-font-white text-center lg:text-start uppercase leading-none mb-4 md:mb-6"
              >
                {currentMember.name}
              </motion.h1>
              ...
              <motion.p 
                ...
                className="font-barlow text-sm md:text-base lg:text-lg text-blue-light text-center lg:text-start leading-relaxed lg:leading-[1.8] max-w-[330px] md:max-w-[460px] lg:max-w-[450px]"
              >
                {currentMember.bio}
              </motion.p>
            </motion.div>

            {/* Navigation Dots (Outside the motion wrapper) */}
